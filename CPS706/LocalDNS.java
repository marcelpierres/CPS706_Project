...
public class LocalDNS {
    ...
    {
       DatagramSocket serverSocket = new DatagramSocket(40450);
          ...
          while(true)
             {
        	  //recived  packet from CLient and saved port and IP address
                ...
                DatagramPacket sendPacket =   new DatagramPacket(sendData, sendData.length, IPAddress, port); // send info back to client
